...
class BlogPost extends Component {
  constructor(props) {
    super(props);
    firebase.initializeApp(firebaseConfig); // inisialisasi konfigurasi database config
  ...
  handleTombolSimpan = (event) => {
    // fungsi untuk meng-handle saat tombol submit di klik
      ...
      <div className="post-artikel">
        ...
        {this.state.listArtikel.map((artikel) => {
          ...
          return (
            ...
            />
          ); // mappingkan data dari API sesuai dengan kategorinya
        })}
      </div>
    );
  }
